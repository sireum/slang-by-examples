...
val b1: B = (T imp_: F) == F // logical-implication, read-only variable definition with explicit type B
val b2 = (T imp_: T imp_: F) == F // logical-implication right-assoc, read-only variable definition with type inference
